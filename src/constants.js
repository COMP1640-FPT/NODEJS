module.exports = {
  CORE: {
    ...
    ACCESS_KEY_ID_S3: process.env.ACCESS_KEY_ID_S3 || "AKIAVF6JF4IEEA4653NX",
    SECRET_ACCESS_KEY_S3: process.env.SECRET_ACCESS_KEY_S3 || "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"
  }
};
